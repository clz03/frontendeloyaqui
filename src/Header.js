          ...
          <div>
            <header className="main-header">
              ...
              <nav className="navbar navbar-static-top">
                ...
                <a href="url_f" className="sidebar-toggle" data-toggle="push-menu" role="button">
                ...
                <div className="navbar-custom-menu">
                  <ul className="nav navbar-nav">
                    ...
                    <li className="dropdown messages-menu">
                      <a href="url_f" className="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li className="footer"><a href="url_f">See All Messages</a></li>
                      </ul>
                    </li>
                    ...
                    <li className="dropdown notifications-menu">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li className="footer"><a href="url_f">View all</a></li>
                      </ul>
                    </li>
                  ...
                  <small>Member since Nov. 2012</small>
                        ...
                        <li className="user-footer">
                          <div className="pull-left">
                            <a href="url_f" className="btn btn-default btn-flat">Profile</a>
                          </div>
                          <div className="pull-right">
                            <a href="url_f" className="btn btn-default btn-flat">Sign out</a>
                          </div>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      <a href="url_f" data-toggle="control-sidebar"><i className="fa fa-gears" /></a>
                    </li>
                  </ul>
                </div>
              </nav>
